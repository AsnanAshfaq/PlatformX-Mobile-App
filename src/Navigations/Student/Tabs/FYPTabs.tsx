...
import OverView from '../../../Screens/Student/FYP/View';
import {createBottomTabNavigator} from '@react-navigation/bottom-tabs';
import {Sizes, Width} from '../../../Constants/Size';
import {useStateValue} from '../../../Store/StateProvider';
import MyCode from '../../../Screens/Student/FYP/MyCode';
    ...
    <Tab.Navigator
      screenOptions={({route}) => ({
        tabBarIcon: ({focused, color, size}) => {
          ...
          } else if (route.name === 'My Code') {
            iconName = focused ? 'code-slash-sharp' : 'code-outline';
          }
