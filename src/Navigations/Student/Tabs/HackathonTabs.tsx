...
import OverView from '../../../Screens/Student/Hackathon/View';
import Participants from '../../../Screens/Student/Hackathon/Participants';
import ViewResult from '../../../Screens/Student/Hackathon/ViewResult';
import Project from '../../../Screens/Student/Hackathon/Project';
...
const TabScreens = ({route}) => {
  ...
  const hackathonID = route.params.ID;
  return (
    <Tab.Navigator
      screenOptions={({route}) => ({
