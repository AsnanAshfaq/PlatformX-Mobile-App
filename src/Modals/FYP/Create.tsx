        ...
        <>
          <View style={styles.headingContainer}>
            <Text
              ...
              {method === 'create' ? 'FYP created successfully' : ''}
            </Text>
          </View>
          ...
          <View style={styles.descriptionContainer}>
            <Text style={[styles.descText, {color: theme.TEXT_COLOR}]}>
              {method === 'create'
                ? `Final Year Project has been created successfully. We have created an online test for the participants. You can view the test results once participants start sending their submissions.${'\n'}Thanks for Choosing PlatformX.`
                : ''}
            </Text>
          </View>
