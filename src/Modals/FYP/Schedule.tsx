...
const ScheduleModal: FC<props> = ({isShow, toggleModal}) => {
        ...
        <>
          ...
          <View style={styles.descriptionContainer}>
            <Text style={[styles.descText, {color: theme.TEXT_COLOR}]}>
              Your meeting has been scheduled on Zoom{'\n'}
              We have sent you an email containing meeting link and other
              instructions.{'\n'}
              Start the meeting on the specified date.
            </Text>
          </View>
