...
const ProjectCreate: FC<props> = ({isShow, toggleModal}) => {
        ...
        <>
          ...
          <View style={styles.descriptionContainer}>
            <Text style={[styles.descText, {color: theme.TEXT_COLOR}]}>
              You have create your hackathon project successfullly.{'\n'}
              You will be informed when the hackathon result gets published.
              {'\n'}
              Good Luck
            </Text>
          </View>
