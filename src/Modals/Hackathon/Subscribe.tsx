...
const SubscribeModal: FC<props> = ({isShow, plan, toggleModal}) => {
        ...
        <>
          ...
          <View style={styles.descriptionContainer}>
            <Text style={[styles.descText, {color: theme.TEXT_COLOR}]}>
              ...
              <Text style={[styles.descText, {color: theme.GREEN_COLOR}]}>
                {plan.charAt(0).toUpperCase() +
                  plan.slice(1, plan.length).toLowerCase()}
              </Text>{' '}
              plan.{'\n'} Now you can start hosting hackathons
            </Text>
          </View>
...
const styles = StyleSheet.create({
  Modalparent: {
    ...
    marginVertical: Height * 0.18, //Height * 0.27
    height: Height * 0.57,
  },
  headingContainer: {
    flex: 0.12,
