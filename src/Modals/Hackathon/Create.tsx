        ...
        <>
          <View style={styles.headingContainer}>
            <Text
              ...
              {method === 'create' ? 'Hackathon created successfully' : ''}
            </Text>
          </View>
          ...
          <View style={styles.descriptionContainer}>
            <Text style={[styles.descText, {color: theme.TEXT_COLOR}]}>
              {method === 'create'
                ? `Hackathon has been created successfully. Now participants will start posting their project on your hackathon.${'\n'}Then you can evaluate their projects and announce results.${'\n'}Thanks for Choosing PlatformX.`
                : ''}
            </Text>
          </View>
