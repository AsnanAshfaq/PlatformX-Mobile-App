...
const JoinWorkshopModal: FC<props> = ({isShow, toggleModal}) => {
      ...
      <>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={[styles.descText, {color: theme.TEXT_COLOR}]}>
            You have successfully participated in this workshop. We have sent
            you an email containing workshop join url and other instructions.
            {'\n'}
          </Text>
        </View>
