...
const WorkshopViewModal: FC<props> = ({isShow, method, toggleModal}) => {
        ...
        <>
          <View style={styles.headingContainer}>
            <Text
              ...
              {method === 'create' ? 'Workshop has been created' : ''}
            </Text>
          </View>
          ...
          <View style={styles.descriptionContainer}>
            <Text style={[styles.descText, {color: theme.TEXT_COLOR}]}>
              {method === 'create'
                ? `Workshop has been created successfully.${'\n'}We have sent you and the speaker of the workshop an email containing meeting start URL and other instructions.${'\n'}Thanks for Choosing PlatformX.`
                : ''}
            </Text>
          </View>
