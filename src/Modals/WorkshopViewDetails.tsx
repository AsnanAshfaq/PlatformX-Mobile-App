...
const WorkshopDetailsModal: FC<props> = ({name, isShow, toggleModal}) => {
      ...
      <View style={{flex: 1}}>
        ...
        <View
          ...
          <Text style={[styles.descriptionText, {color: theme.DIM_TEXT_COLOR}]}>
            We have sent you an email containing workshop link and other
            instructions.{'\n'}
            You can join the workshop via link on the date and time specified.
          </Text>
        </View>
        {/* done button  */}
